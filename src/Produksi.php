...
<main class="flex-1 bg-gray-100">
  <section class="p-6 overflow-x-auto space-y-6">
    ...
    <button id="btnTambahProduk" type="button" class="inline-flex items-center gap-2 rounded-md bg-[#800020] px-4 py-2 text-white text-sm font-normal hover:bg-[#f7b5c6] transition-colors">
            ...
            <?php foreach ($produksi_list as $index => $item): ?>
              <tr>
                ...
                <td class="border border-gray-300 px-2 py-1 space-x-1">
                  <button type="button" class="btnEdit bg-[#FFCCD8] text-gray-800 text-xs px-3 py-0.5 rounded hover:bg-[#f7b5c6] transition-colors"
    ...
    <table class="w-full max-w-xs border border-gray-300 border-collapse text-xs text-black bg-white mt-1">
      <thead>
        <tr class="bg-[#FFE4EB] text-center font-normal">
