...
<main class="flex-1 bg-gray-100">
  <section class="p-6 overflow-x-auto">
    ...
    <button id="btnTambahStok" class="mb-4 inline-flex items-center gap-2 bg-[#800020] text-white text-sm font-medium px-4 py-2 rounded hover:bg-[#f7b5c6] transition-all" type="button">
      <i class="fas fa-plus"></i> Tambah Stok
    </button>

    <table class="w-full border border-gray-300 text-sm bg-white">
      <thead class="bg-[#FFE4EB] sticky top-0 z-10">
          ...
          <?php foreach ($stok_list as $index => $item): ?>
            <tr>
              ...
              <td class="border border-gray-300 px-3 py-2 space-x-2">
                <button class="btnEdit bg-[#FFCCD8] text-black text-xs px-3 py-1 rounded hover:bg-[#f7b5c6] transition-all"
                ...
                <button class="btnHapus bg-red-700 text-white text-xs px-3 py-1 rounded hover:bg-red-800 transition-all"
  ...
  <!-- Semua modal tombol submit dan header warna diganti ke pink lembut -->
  <div id="modalTambah" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <form action="" method="POST" class="bg-white p-6 shadow-md rounded w-80 relative">
      ...
      <div class="mb-4">
        ...
        <select name="id_produksi" id="id_produksi_tambah" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-2 focus:ring-[#FFCCD8]" required>
      ...
      <div class="mb-2">
        ...
        <input type="number" name="jumlah_stok" id="jumlah_stok_tambah" class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#FFCCD8]" min="1" required />
        <div id="jumlahError" class="text-xs text-red-600 mt-1 hidden"></div>
      </div>
      <div class="mb-4">
        <label>Status Stok</label>
        <select name="status_stok" id="status_stok_tambah" class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#FFCCD8]" required>
      ...
      <button type="submit" name="submit" class="w-full bg-[#FFCCD8] text-black py-2 rounded hover:bg-[#f7b5c6] transition-all">Simpan</button>
    </form>
  </div>
  ...
  <div id="modalEdit" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <form action="" method="POST" class="bg-white p-6 shadow-md rounded w-80 relative">
      ...
      <div class="mb-4">
        ...
        <select name="status_stok" id="status_stok_edit" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-2 focus:ring-[#FFCCD8]" required>
          <option value="Siap dikemas">Siap dikemas</option>
          <option value="Siap dipacking">Siap dipacking</option>
          <option value="Sudah dipacking">Sudah dipacking</option>
          <option value="Reject">Reject</option>
      ...
      <div class="mb-6">
        ...
        <input type="number" name="jumlah_stok" id="jumlah_stok_edit" min="0" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-2 focus:ring-[#FFCCD8]" required />
      </div>

      <button type="submit" name="submit" class="w-full bg-[#FFCCD8] text-black py-2 rounded hover:bg-[#f7b5c6] transition-all">Simpan Perubahan</button>
    </form>
  </div>
